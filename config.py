...
class ProductionConfig(Config):
    SQLALCHEMY_DATABASE_URI = "postgresql://postgres:Cabra_2023_Bobo@abcjobsdbinstancias.ckdctflafdko.us-east-2.rds.amazonaws.com:5432/EmpresasBD"
...
class StagingConfig(Config):
    SQLALCHEMY_DATABASE_URI = "postgresql://postgres:Cabra_2023_Bobo@abcjobsdbinstancias.ckdctflafdko.us-east-2.rds.amazonaws.com:5432/EmpresasTestBD"
    JWT_ACCESS_TOKEN_EXPIRES = False
...
class TestingConfig(Config):
    DEBUG = True
    TESTING = True
    SQLALCHEMY_DATABASE_URI = 'postgresql://admin:admin@localhost:5432/EmpresasTestBD'
    JWT_ACCESS_TOKEN_EXPIRES = False
